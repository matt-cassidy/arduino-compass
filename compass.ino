...
char* PIN_MAP[] = { "NORTH", "EAST", "SOUTH", "WEST" };
...
void loop()
{
  ...
  if(currentMillis - previousMillis > interval)
  {
    ...
    pulseHandlers(4, ordinalValue,degreeValue);     
...
void pulseHandlers(int amount, int ordinalValue, float degreeValue)
{
...
char* mapPinToTest(int pin)
{
  return PIN_MAP[pin - 9]; 
}
...
void CallHandler(int ordinal,float degreeValue)
{
...
void turnOffPin(int pin)
{
  ...
  {
     Serial.print("OFF: "); 
     Serial.println(mapPinToTest(pin));
  }
